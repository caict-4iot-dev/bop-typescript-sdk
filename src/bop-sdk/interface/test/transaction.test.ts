...
describe("provider-transaction-test", () => {
  ...
  beforeEach(() => {
    ...
    signer = new SignerByBop(
      "priSrroXTmScmv9EmCcZMGKp155u5zxp6vxFvRRjVXZdATiS7a",
    );

    signer2 = new SignerByBop(
      "priSPKt1L7QcNebG98VaYUxs3bpVwaBXyvEg5RwohfsUM1ectb",
    );
  ...
  describe("transaction test", () => {
    ...
    //   );
    //   console.log(response);
    //   console.log(JSON.stringify(GetTransactionHistoryResponse.toJSON(response)));
    //   expect(response.errorCode).to.equal(0);
    //   expect(response.errorDesc).to.equal("ok");
    ...
    //     let response: GetTransactionHistoryResponse;
    //     response = await transaction.getTransactionHistory(5845127, undefined, undefined, "7370f1759c37f09268d72019c006b6167392d21186e11b0bd098148ac8f34479");
    //     console.log(response);
    //     console.log(JSON.stringify(GetTransactionHistoryResponse.toJSON(response)));
    //     expect(response.errorCode).to.equal(0);
    //     expect(response.errorDesc).to.equal("ok");
    ...
    //     let response: GetTransactionHistoryResponse;
    //     response = await transaction.getTransactionHistory(undefined, undefined, undefined, "");
    //     console.log(response);
    //     expect(response.errorCode).to.equal(0);
    //   });
    //   it("transaction.getTransactionHistory with hash invalid", async () => {
    //     let response: GetTransactionHistoryResponse;
    //     response = await transaction.getTransactionHistory(undefined, undefined, undefined, "xxx");
    //     console.log(response);
    //     expect(response.errorCode).to.equal(4);
    //   });
    ...
    //     let response: GetTransactionHistoryResponse;
    //     response = await transaction.getTransactionHistory(undefined, 9999999999999);
    //     console.log(response);
    //     expect(response.errorCode).to.equal(0);
    //   });
    //   it("transaction.getTransactionHistory with limit 0", async () => {
    //     let response: GetTransactionHistoryResponse;
    //     response = await transaction.getTransactionHistory(undefined, undefined, 0);
    //     console.log(response);
    //     expect(response.errorCode).to.equal(0);
    //   });
    //   it("transaction.getTransactionHistory with limit negative", async () => {
    //     let response: GetTransactionHistoryResponse;
    //     response = await transaction.getTransactionHistory(undefined, undefined, -1);
    //     console.log(response);
    //     expect(response.errorCode).to.equal(0);
    //   });
    //   it("transaction.getTransactionHistory with limit more than max", async () => {
    //     let response: GetTransactionHistoryResponse;
    //     response = await transaction.getTransactionHistory(undefined, undefined, 9999999999999);
    //     console.log(response);
    //     expect(response.errorCode).to.equal(0);
    //   });
    ...
    //     response = await transaction.buildGasSendTx(request, [signerWithProvider]);
    //     console.log(response);
    //     expect(response.errorCode).to.equal(0);
    ...
    //       remarks: "",
    //     },
    //     destAddress: "did:bid:efyNgwkbq7dLkuziVJkbik7fy2Dtmx92",
    //     amount: 1
    //   };
    //   console.log(request);
    //   let signerWithProvider = signer.connect(provider);
    //   let response: OffLineTxResponse;
    //   response = await transaction.buildAccountCreateTx(
    //     request,
    //     [signerWithProvider],
    //   );
    //   console.log(response);
    ...
    //   let signerWithProvider = signer.connect(provider);
    //   let response: OffLineTxResponse;
    //   response = await transaction.buildContractCreateTx(
    //     request,
    //     [signerWithProvider],
    //   );
    //   console.log(response);
    ...
    //     let signerWithProvider = signer.connect(provider);
    //     let response: OffLineTxResponse;
    //     response = await transaction.buildContractInvokeTx(
    //       request,
    //       [signerWithProvider],
    //     );
    //     console.log(response);
    ...
    //   let signerWithProvider = signer.connect(provider);
    //   let response: OffLineTxResponse;
    //   response = await transaction.buildSetMetadataTx(
    //     request,
    //     [signerWithProvider],
    //   );
    //   console.log(response);
    ...
    //   let signerWithProvider = signer.connect(provider);
    //   let response: OffLineTxResponse;
    //   response = await transaction.buildSetPrivilegeTx(
    //     request,
    //     [signerWithProvider],
    //   );
    //   console.log(response);
    ...
    //   let signerWithProvider = signer.connect(provider);
    //   let response: OffLineTxResponse;
    //   response = await transaction.buildBatchGasSend(
    //     request,
    //     [signerWithProvider],
    //   );
    //   console.log(response);
    ...
    //         input:
    //           '{"function":"store(uint256)","args":"5"}',
    //         amount: 0,
    //       },
    //       {
    //         contractAddress: "did:bid:efYzPhz9f3aFNAZZ42bhbLetBxPyYLdk",
    //         input:
    //           '{"function":"store(uint256)","args":"6"}',
    //         amount: 0,
    //       }
    //     ],
    //   };
    ...
    //   let signerWithProvider = signer.connect(provider);
    //   let response: OffLineTxResponse;
    //   response = await transaction.buildBatchContractInvoke(
    //     request,
    //     [signerWithProvider],
    //   );
    //   console.log(response);
    ...
    //   tx.result.signatures[0].signData = "52936dffa7ca865b592ea2d2ad5b3d0a679eb1524fdb61389018cfee0ad3b31a89dbb6ff2da9a2b228275850c2293cd20df71747a11e77769b04b090dc9d003d"
    //   let subresponse: SubmitTransactionResponse;
